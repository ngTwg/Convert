...
$installerPath = Get-ChildItem "installer_output\MultiConvert_Setup_*.exe" | Select-Object -First 1
if ($installerPath) {
    ...
    Write-Host "  ✓ Professional installation wizard with Vietnamese & English support" -ForegroundColor White
